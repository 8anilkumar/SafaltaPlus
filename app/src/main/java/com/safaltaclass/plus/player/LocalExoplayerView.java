...
import com.safaltaclass.plus.Interface.ExoPlayerCallBack;
import com.safaltaclass.plus.R;

import java.util.HashMap;
import java.util.Map;

public class LocalExoplayerView extends LinearLayout implements View.OnClickListener {
    ...
    public class ComponentListener implements Player.EventListener {
        ...
        String TAG = LocalExoplayerView.ComponentListener.class.getSimpleName();
    ...
    public LocalExoplayerView(Context context) {
        super(context);
        initializeView(context);
    }

    public LocalExoplayerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public LocalExoplayerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
