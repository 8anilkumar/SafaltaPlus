...
public class DownloadFile extends AsyncTask<Boolean,Void,Boolean> {
    ...
    public DownloadFile(Context context,String url, String fileTitle, Cipher cipher, Integer pos,long byteRange,File file, FileDownLoadListener listener) {
    ...
    protected void onPostExecute(Boolean aBoolean) {
        ...
        if (aBoolean) {
          ...
          //  SafaltaPlusPreferences.getInstance().removeDownloading(fileName);
